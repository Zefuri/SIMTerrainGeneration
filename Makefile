...
DISTDIR = /home/lorentzr/Bureau/s7/sim/SIM/SIMTerrainGeneration/.tmp/terrain1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lGLEW -lGLU -lm -lGL -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Xml -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
